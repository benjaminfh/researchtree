-- Prevent lease overwrite on concurrent acquisition attempts.
...
begin
  ...
  insert into public.ref_leases (project_id, ref_id, holder_user_id, holder_session_id, expires_at)
    ...
    where public.ref_leases.expires_at <= v_now
       or (public.ref_leases.holder_user_id = auth.uid()
           and public.ref_leases.holder_session_id = p_session_id);
