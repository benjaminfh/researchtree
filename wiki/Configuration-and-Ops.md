...
- `LLM_ENABLED_PROVIDERS` (comma-separated provider IDs; `mock` is invalid in prod)
- `OPENAI_CHATCOMPLETIONS_MODEL`, `OPENAI_RESPONSES_MODEL`, `GEMINI_MODEL`, `ANTHROPIC_MODEL`
- `LLM_ALLOWED_MODELS_OPENAI_CHATCOMPLETIONS`, `LLM_ALLOWED_MODELS_OPENAI_RESPONSES`, `LLM_ALLOWED_MODELS_GEMINI`, `LLM_ALLOWED_MODELS_ANTHROPIC`
