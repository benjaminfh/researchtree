...
describe('label placement helpers', () => {
  it('computes row bounds from node lanes and per-row edge lane pairs', () => {
    const placement = computeRowLabelPlacement(
      [0, 1, 0],
      [
        [],
        [[0, 1]],
    ...
    expect(placement.rowBoundByIndex).toEqual([0, 1, 2]);
