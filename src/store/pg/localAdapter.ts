...
const RPC_CONFIG: Record<string, { params: string[]; returnType: RpcReturnType }> = {
  ...
  rt_list_project_members_v1: { params: ['p_project_id'], returnType: 'set' },
  rt_list_project_invites_v1: { params: ['p_project_id'], returnType: 'set' },
  rt_invite_project_member_v1: { params: ['p_project_id', 'p_email', 'p_role'], returnType: 'set' },
  rt_update_project_member_role_v1: { params: ['p_project_id', 'p_user_id', 'p_role'], returnType: 'void' },
  rt_remove_project_member_v1: { params: ['p_project_id', 'p_user_id'], returnType: 'void' },
  rt_update_project_invite_role_v1: { params: ['p_project_id', 'p_invite_id', 'p_role'], returnType: 'void' },
  rt_revoke_project_invite_v1: { params: ['p_project_id', 'p_invite_id'], returnType: 'void' },
  rt_accept_project_invites_v1: { params: ['p_email'], returnType: 'set' },
  rt_get_project_owner_v1: { params: ['p_project_id'], returnType: 'set' },
  rt_get_project_main_ref_updates_v1: { params: ['p_project_ids'], returnType: 'set' },
  rt_list_ref_leases_v1: { params: ['p_project_id'], returnType: 'set' },
  rt_acquire_ref_lease_v1: { params: ['p_project_id', 'p_ref_id', 'p_session_id', 'p_ttl_seconds'], returnType: 'void' },
  rt_release_ref_lease_v1: { params: ['p_project_id', 'p_ref_id', 'p_session_id', 'p_force'], returnType: 'void' },
