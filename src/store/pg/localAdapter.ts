...
const RPC_CONFIG: Record<string, { params: string[]; returnType: RpcReturnType }> = {
  ...
  rt_get_project_member_role_v1: { params: ['p_project_id'], returnType: 'scalar' },
  ...
  rt_share_project_by_email_v1: { params: ['p_project_id', 'p_email', 'p_role'], returnType: 'set' },
  ...
  rt_remove_project_invite_v1: { params: ['p_project_id', 'p_invite_id'], returnType: 'void' },
  rt_update_project_invite_role_v1: { params: ['p_project_id', 'p_invite_id', 'p_role'], returnType: 'void' },
  rt_accept_project_invites_v1: { params: [], returnType: 'set' },
  rt_list_ref_leases_v1: { params: ['p_project_id'], returnType: 'set' },
  rt_acquire_ref_lease_v1: { params: ['p_project_id', 'p_ref_id', 'p_session_id', 'p_ttl_seconds'], returnType: 'set' },
  rt_release_ref_lease_v1: { params: ['p_project_id', 'p_ref_id', 'p_session_id'], returnType: 'scalar' },
